...
- \`set_channel(name, secret?, index?)\` — add/update a channel; omit \`secret\` for a random private channel, \`index\` for the next free slot. List channels at \`meshcore://channels\`.
